...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/GrpcService.proto")
public final class GreetingServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<es.noelalonso.gprc.msg.GrpcMessages.Greeting,
      es.noelalonso.gprc.msg.GrpcMessages.Greeting> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.<es.noelalonso.gprc.msg.GrpcMessages.Greeting, es.noelalonso.gprc.msg.GrpcMessages.Greeting>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "GreetingService", "SayHello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              es.noelalonso.gprc.msg.GrpcMessages.Greeting.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              es.noelalonso.gprc.msg.GrpcMessages.Greeting.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<es.noelalonso.gprc.msg.GrpcMessages.Greeting,
      es.noelalonso.gprc.msg.GrpcMessages.Greeting> METHOD_SAY_HELLO_STREAM =
      io.grpc.MethodDescriptor.<es.noelalonso.gprc.msg.GrpcMessages.Greeting, es.noelalonso.gprc.msg.GrpcMessages.Greeting>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "GreetingService", "SayHelloStream"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              es.noelalonso.gprc.msg.GrpcMessages.Greeting.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              es.noelalonso.gprc.msg.GrpcMessages.Greeting.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(es.noelalonso.gprc.msg.GrpcMessages.Greeting request,
        io.grpc.stub.StreamObserver<es.noelalonso.gprc.msg.GrpcMessages.Greeting> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SAY_HELLO, responseObserver);
    }

    /**
     */
    public void sayHelloStream(es.noelalonso.gprc.msg.GrpcMessages.Greeting request,
        io.grpc.stub.StreamObserver<es.noelalonso.gprc.msg.GrpcMessages.Greeting> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SAY_HELLO_STREAM, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                es.noelalonso.gprc.msg.GrpcMessages.Greeting,
                es.noelalonso.gprc.msg.GrpcMessages.Greeting>(
  ...
  public static final class GreetingServiceStub extends io.grpc.stub.AbstractStub<GreetingServiceStub> {
    ...
    public void sayHelloStream(es.noelalonso.gprc.msg.GrpcMessages.Greeting request,
        io.grpc.stub.StreamObserver<es.noelalonso.gprc.msg.GrpcMessages.Greeting> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(METHOD_SAY_HELLO_STREAM, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public es.noelalonso.gprc.msg.GrpcMessages.Greeting sayHello(es.noelalonso.gprc.msg.GrpcMessages.Greeting request) {
    ...
    /**
     */
    public java.util.Iterator<es.noelalonso.gprc.msg.GrpcMessages.Greeting> sayHelloStream(
        es.noelalonso.gprc.msg.GrpcMessages.Greeting request) {
      return blockingServerStreamingCall(
          getChannel(), METHOD_SAY_HELLO_STREAM, getCallOptions(), request);
    }
  }
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<es.noelalonso.gprc.msg.GrpcMessages.Greeting> sayHello(
        es.noelalonso.gprc.msg.GrpcMessages.Greeting request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((es.noelalonso.gprc.msg.GrpcMessages.Greeting) request,
              (io.grpc.stub.StreamObserver<es.noelalonso.gprc.msg.GrpcMessages.Greeting>) responseObserver);
          break;
        case METHODID_SAY_HELLO_STREAM:
          serviceImpl.sayHelloStream((es.noelalonso.gprc.msg.GrpcMessages.Greeting) request,
              (io.grpc.stub.StreamObserver<es.noelalonso.gprc.msg.GrpcMessages.Greeting>) responseObserver);
          break;
        default:
  ...
  private static final class GreetingServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return es.noelalonso.gprc.svc.GrpcService.getDescriptor();
    }
  }
